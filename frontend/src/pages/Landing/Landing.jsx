    ...
    <div className="landing-page">
      ...
      <main className="landing-hero">
        <div className="landing-copy">
          ...
          <p>
            An interactive exploration of the Bank Marketing dataset,
            exploratory analysis, Gaussian Naive Bayes evaluation, and
        ...
        <div className="landing-panel">
          <div className="landing-panel__top">
            <div>
              <div className="landing-panel__label">
                PROJECT SNAPSHOT
              </div>

              <div className="landing-panel__title">
      ...
      <footer className="landing-footer">
        <span>Bank Marketing Campaign Prediction System</span>
